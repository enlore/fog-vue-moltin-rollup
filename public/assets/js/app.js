...
var Product = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"product"},[_c('div',{staticClass:"card"},[_c('div',{staticClass:"card-header"},[_c('h3',{staticClass:"card-header-title"},[_vm._v(_vm._s(_vm.product.name))])]),_c('div',{staticClass:"card-image"},[_c('img',{attrs:{"src":_vm.mainImage}})]),_c('div',{staticClass:"card-content"},[_c('p',[_vm._v(_vm._s(_vm.product.description))])]),_c('div',{staticClass:"card-footer"},[_c('a',{staticClass:"card-footer-item",on:{"click":function($event){_vm.$emit('addToCart', _vm.product);}}},[_vm._v("Add to Cart")])])])])},staticRenderFns: [],_scopeId: 'data-v-3cf4ef6f',
    data: function data () {
        return {
        }
    },
    ...
    created: function created () {
        console.info('a product!');
    }
};

var ProductAsLineItem = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('tr',{staticClass:"productAsLineItem"},[_c('td',[_c('a',{staticClass:"productAsLineItem-removeControl",on:{"click":function($event){_vm.$emit('removeItem', _vm.id);}}},[_vm._v("x")]),_c('span',{staticClass:"productAsLineItem-name"},[_vm._v(_vm._s(_vm.name))])]),_c('td',[_c('div',{staticClass:"has-text-centered"},[_vm._v(_vm._s(_vm.quantity))]),_c('div',{staticClass:"productAsLineItem-controls"},[_c('a',{staticClass:"productAsLineItem-quantityControl",on:{"click":function($event){_vm.$emit('decrementItem', _vm.productId);}}},[_vm._v("-")]),_c('a',{staticClass:"productAsLineItem-quantityControl",on:{"click":function($event){_vm.$emit('incrementItem', _vm.productId);}}},[_vm._v("+")])])]),_c('td',{staticClass:"has-text-right"},[_vm._v(_vm._s(_vm.price))])])},staticRenderFns: [],_scopeId: 'data-v-7e9319c8',
    data: function data () {
        return {
...
var Cart = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"cart"},[(_vm.cartProducts.length > 0)?_c('table',{staticClass:"table is-fullwidth is-striped cart-products"},[_c('thead',[_c('tr',[_c('th',[_c('a',{staticClass:"cart-refreshControl",on:{"click":function($event){_vm.$emit('refreshItems');}}},[_vm._v("↻")])]),_c('th',{staticClass:"has-text-centered"},[_vm._v("Quantity")]),_c('th',{staticClass:"has-text-right"},[_vm._v("Price")])])]),_c('tbody',_vm._l((_vm.cartProducts),function(product){return _c('product-as-line-item',{attrs:{"id":product.id,"productId":product.product_id,"name":product.name,"quantity":product.quantity,"price":product.unit_price.amount},on:{"incrementItem":function($event){_vm.$emit('incrementItem', arguments[0]);},"decrementItem":function($event){_vm.$emit('decrementItem', arguments[0]);},"removeItem":function($event){_vm.$emit('removeItem', arguments[0]);}}})})),_c('tfoot',[_c('tr',[_c('td',[_c('a',{staticClass:"cart-checkoutControl"},[_vm._v("Checkout")]),_c('a',{staticClass:"cart-checkoutControl",on:{"click":function($event){_vm.$emit('deleteCart');}}},[_vm._v("Empty")])]),_vm._m(0),_c('td',[_c('div',{staticClass:"cart-padded has-text-right"},[_vm._v(_vm._s(_vm.meta.display_price.with_tax.formatted))])])])])]):_c('div',{staticClass:"cart-products"},[_c('h3',[_vm._v("Nothing in your cart")])])])},staticRenderFns: [function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('td',{staticClass:"has-text-right has-text-black"},[_c('div',{staticClass:"cart-padded"},[_vm._v("Total")])])}],_scopeId: 'data-v-530ad160',
    name: 'cart',
    ...
    computed: {
        cartProducts: function cartProducts () {
            return this.items.sort(function (a, b) { return a.name > b.name; })
        }
    },
    ...
    components: {
        ProductAsLineItem: ProductAsLineItem
    }
};

var Flash = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"flash",style:(_vm.isShowing)},[_vm._l((_vm.flashes),function(flash){return [_c('h1',{staticClass:"flash-msg"},[_vm._v(_vm._s(flash.msg))])]})],2)},staticRenderFns: [],_scopeId: 'data-v-ab373820',
    data: function data () {
        return {
...
var Loading = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"loading",class:{ 'is-spinning': _vm.spin },style:({ display: _vm.show ? 'block' : 'none' })},[_vm._v("↻")])},staticRenderFns: [],
    data: function data () {
        return {
...
var App = {render: function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"root-view"},[_vm._m(0),_c('div',{staticClass:"section"},[_c('div',{staticClass:"container"},[_c('cart',{attrs:{"items":_vm.cartItems,"meta":_vm.cartMeta},on:{"refreshItems":_vm.getCartItems,"incrementItem":_vm.incrementItem,"decrementItem":function($event){_vm.doFlash('://TODO', 'huge');},"removeItem":_vm.removeItem,"deleteCart":_vm.deleteCart}})],1)]),_c('div',{staticClass:"section"},[_c('div',{staticClass:"container"},[(_vm.products.length > 0)?_c('div',{staticClass:"products columns"},_vm._l((_vm.products),function(product){return _c('product',{staticClass:"column",attrs:{"product":product,"mainImage":_vm.mainProductImage(product)},on:{"addToCart":_vm.addToCart}})})):_c('div',{staticClass:"products"},[_c('h2',[_vm._v("have not products")])])])]),_c('flash',{attrs:{"show":_vm.flashShowing,"flashes":_vm.activeFlashes}}),_c('loading',{attrs:{"show":true,"spin":true}})],1)},staticRenderFns: [function(){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"hero siteHeader"},[_c('div',{staticClass:"hero-body"},[_c('div',{staticClass:"container"},[_c('h1',{staticClass:"title siteTitle"},[_vm._v("BUY")])])])])}],
    name: 'root',
    ...
    methods: Object.assign({}, mapActions([
        ...
        {mainProductImage: function mainProductImage (product) {
            var mi = product.relationships.main_image;

            if (mi) {
                var image = this.main_images[mi.data.id];
        ...
        doFlash: function doFlash (msg, type) {
            var this$1 = this;

            this.flash({ msg: msg, type: type });
            ...
            var to = setTimeout(function () {
                if (to) {
                    clearTimeout(to);
                    to = null; }
                this$1.flashShowing = false;
                this$1.resolveActiveFlashes();
            }, 2000);
        }}),
...
var actions = {
    ...
    deleteCart: function deleteCart (ref) {
        var commit = ref.commit;
        var dispatch = ref.dispatch;

        Vue$3$1.$shop.deleteCart()
            .then(function (deletedCartMeta) {
    ...
    addToCart: function addToCart (ref, product) {
        var commit = ref.commit;

        Vue$3$1.$shop.addToCart(product.id, 1)
            .then(function (cartProduct) {
                console.info(cartProduct);
                return Vue$3$1.$shop.getCartItems()
            })
            .then(function (cart) {
    ...
    removeItem: function removeItem(ref, productId) {
        var commit = ref.commit;
        var dispatch = ref.dispatch;

        Vue$3$1.$shop.removeItem(productId)
    ...
    incrementItem: function incrementItem(ref, productId) {
        var dispatch = ref.dispatch;

        return dispatch('addToCart', { id: productId })
    },

    decrementItem: function decrementItem(ref, productId) {
        var commit = ref.commit;


    },

    getCartItems: function getCartItems (ref) {
        var commit = ref.commit;

        Vue$3$1.$shop.getCartItems()
            .then(function (cart) {
                commit('setCartItems', cart.data);
                commit('setCartMeta', cart.meta);
            })
    ...
    flash: function flash (ref, ref$1) {
        var commit = ref.commit;
        var msg = ref$1.msg;
        var type = ref$1.type;

        commit('commitFlash', { msg: msg, type: type });
        commit('activeFlash', { msg: msg, type: type });
    },

    resolveActiveFlashes: function resolveActiveFlashes (ref) {
        var commit = ref.commit;
...
var mutations = {
    setProducts: function setProducts (state, prods) {
        state.products = prods;
    },

    setIncluded: function setIncluded (state, included) {
    ...
    setCartItems: function setCartItems (state, items) {
        state.cartItems = items;
    },

    setCartMeta: function setCartMeta (state, meta) {
        state.cartMeta = meta;
    },

    commitError: function commitError (state, error) {
        Vue$3$1.set(state.errors, state.idx, { error: error, resolved: false });
        state.idx = (state.idx + 1) % 100;
        state.errorCount += 1;
    },

    commitFlash: function commitFlash (state, flash) {
        Vue$3$1.set(state.flashes, state.flashIdx, { flash: flash, resolved: false });
        state.flashIdx = (state.flashIdx + 1) % 100;
        state.flashCount += 1;
    },

    activeFlash: function activeFlash (state, flash) {
        state.activeFlashes.push(flash);
    },

    resolveActiveFlashes: function resolveActiveFlashes (state) {
        state.activeFlashes = [];
    }
};

var getters = {
    main_images: function main_images (state) {
        var mi = state.included.main_images || [];
        return Vue$3$1.$_.keyBy(mi, 'id')
    },

    files: function files (state) {
        var files = state.included.files || [];
        return Vue$3$1.$_.keyBy(files, 'id')
    }
};
...
Shop.prototype.getProducts = function getProducts (offset, limit) {
...
Shop.prototype.addToCart = function addToCart (productId, count) {
...
Shop.prototype.getCartItems = function getCartItems () {
    return this.client.Cart.Items()
};

Shop.prototype.deleteCart = function deleteCart () {
    return this.client.Cart.Delete()
};

Shop.prototype.removeItem = function removeItem (itemId) {
    return this.client.Cart.RemoveItem(itemId)
};

Shop.prototype.createOrder = function createOrder (customer, billingAddress, shippingAddress) {
    var orderInfo = {
        customer: {
            name: 'John Doe',
            email: 'john@doe.co'
...
Shop.prototype.processPayment = function processPayment (order) {
